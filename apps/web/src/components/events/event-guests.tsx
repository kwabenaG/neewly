...
import { AddGuestDialog } from '../guests/add-guest-dialog';
import { ImportGuestsDialog } from '../guests/import-guests-dialog';
...
export function EventGuests({ eventId }: EventGuestsProps) {
  ...
  const fetchGuests = async () => {
    try {
      ...
      const response = await apiClient.getEventGuests(token, eventId);
        ...
        <CardContent>
          {filteredGuests.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">Start by adding guests to your list or importing from a CSV file.</p>
              <Button onClick={() => setIsAddDialogOpen(true)}>
                <Plus className="h-4 w-4 mr-2" />
